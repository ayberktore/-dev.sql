...
SET name = ‘Ayberk’,
	Birhday = ‘2000-08-07’,
	Email = ‘toreayberk@gmail.com’
WHERE id = 1
RETURNING *;


-- ID'si 4 olan verinin doğum tarihini 2003-11-23 olarak güncelle ve güncellenen verileri göster.
UPDATE employee
SET Birhday = ‘2003-11-23’,
WHERE id = 4
RETURNING *;


-- İsmi 'J' ile başlayan verilerin ismini 'Jason' olarak güncelle ve güncellenen verileri göster.
UPDATE employee
SET name = 'Jason'
WHERE name LIKE 'J%'
RETURNING *;

-- ID'si 20 olan verinin adını 'Kyrie', emailini ise 'kyrieirving@gmail.com' olarak güncelle ve güncellenen verileri göster.
UPDATE employee
SET name = 'Kyrie',
...
-- Emaili 'L' ile başlayan verinin adını 'LeBron' olarak güncelle ve güncellenen verileri göster.
UPDATE employee
SET name = 'LeBron',
WHERE email LIKE ‘L%’
RETURNING *;
